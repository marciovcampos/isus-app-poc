...
(0, _riteway.describe)('getQueryFeatureNames()', function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            assert({
              ...
              actual: (0, _getQueryFeatureNames.getQueryFeatureNames)(),
              expected: []
            });
            ...
            assert({
              given: 'empty object',
              should: 'return an empty array',
              actual: (0, _getQueryFeatureNames.getQueryFeatureNames)(query),
              expected: []
            });
            ...
            assert({
              ...
              should: 'return an empty array',
              actual: (0, _getQueryFeatureNames.getQueryFeatureNames)(_query),
              expected: []
            });
            _query2 = (0, _deepFreeze2.default)({ foo: 'something', ft: 'foo,bar,help' });

            assert({
              given: 'query object with key of ft and a value of a string of features',
              should: 'return an array of the features',
              actual: (0, _getQueryFeatureNames.getQueryFeatureNames)(_query2),
