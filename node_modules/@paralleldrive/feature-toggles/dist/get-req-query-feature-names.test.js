...
(0, _riteway.describe)('getReqQueryFeatureNames()', function () {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            assert({
              ...
              actual: (0, _getReqQueryFeatureNames.getReqQueryFeatureNames)(),
              expected: []
            });
            ...
            assert({
              ...
              should: 'return an empty array',
              actual: (0, _getReqQueryFeatureNames.getReqQueryFeatureNames)(req),
              expected: []
            });
            ...
            assert({
              given: 'incorrectly formed req object',
              should: 'return an empty array',
              actual: (0, _getReqQueryFeatureNames.getReqQueryFeatureNames)(_req),
              expected: []
            });
            ...
            assert({
              given: 'incorrectly formed req object',
              should: 'return an empty array',
              actual: (0, _getReqQueryFeatureNames.getReqQueryFeatureNames)(_req2),
              expected: []
            });
            ...
            assert({
              ...
              actual: (0, _getReqQueryFeatureNames.getReqQueryFeatureNames)(_req3),
