...
var _withFeatures = require('./with-features');
...
(0, _riteway.describe)('withFeatures()', function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(assert) {
    var TestComponentWithHoC, features, $, _TestComponentWithHoC, _features, _$;

    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            TestComponentWithHoC = (0, _withFeatures.withFeatures)(function (_ref2) {
            ...
            $ = _cheerio2.default.load(render(_react2.default.createElement(
              _context2.Provider,
              { value: features },
              _react2.default.createElement(TestComponentWithHoC, null)
            )));
            ...
            _TestComponentWithHoC = (0, _withFeatures.withFeatures)(function (_ref3) {
            ...
            _$ = _cheerio2.default.load(render(_react2.default.createElement(
              _context2.Provider,
              { value: _features },
              _react2.default.createElement(_TestComponentWithHoC, null)
            )));
